...
const safeDependenciesPlugin = require('../webpack-resolver-plugins/safe-dependencies-plugin')
...
module.exports = function build({ watch }) {
  ...
  function resolveOptions() {
    return {
      ...
      plugins: [absolutePathResolverPlugin(srcDir), fragmentResolverPlugin(), safeDependenciesPlugin(srcDir)]
    }
  }
